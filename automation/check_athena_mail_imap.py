#!/usr/bin/env python3
"""Fetch new emails from IMAP (athena@aner.de - Hosteurope) and output digestable JSON.

Mailboxes: INBOX
Credentials: from ~/.config/mbsync/aner.pass
"""
...
STATE_PATH = WORKSPACE / 'memory' / 'athena-imap-monitor-state.json'
PASS_PATH = Path.home() / '.config' / 'mbsync' / 'aner.pass'

HOST = 'wp010.webpack.hosteurope.de'
PORT = 993
USER = 'wp1055757-wohnung'
